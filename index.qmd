...
This paper conducts an analysis of grant application data from the Russian Foundation for Basic Research (RFBR) between 1994 and 2016. The RFBR is a government-funded organization that financially supports a wide range of projects in the fields of STEM as well as the humanities and social sciences. The data analyzed in this study includes over 400,000 grant applications (both supported and rejected) and covers eight main research areas as defined by the RFBR.
...
Gender inequality in the fields of STEM has been a topic of significant concern in recent years. Studies have shown that women are underrepresented in STEM fields, and that they face numerous barriers to career advancement and funding opportunities. This study aims to contribute to the existing body of research by providing a detailed analysis of grant application data from a large government-funded organization in Russia.

In addition, this study also aims to explore the representation of women in the Humanities & Social Sciences fields and the acceptance rates of grant applications in these areas. This is important because the lack of representation of women in the field of Humanities & Social Sciences can also have a significant impact on the field itself, as well as on society as a whole.
